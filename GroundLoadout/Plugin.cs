...
namespace GroundLoadout
{
    [BepInPlugin("com.RaksaPutra.GroundLoadout", "Ground Loadout", "1.0.0")]
    public class GroundLoadoutPlugin : BaseUnityPlugin
    {
        public static GroundLoadoutPlugin Instance;
        ...
        private IEnumerator InitLoadouts()
        {
            ...
            {
                // Exclude ships and aircraft (handled by other mods or logic)
                if (unitDef is ShipDefinition || unitDef is AircraftDefinition || unitDef is MissileDefinition) continue;
            ...
            Logger.LogInfo($"Ground Loadout initialized. Modded {moddedCount} units. Found {allMissiles.Count} missiles.");
        }
